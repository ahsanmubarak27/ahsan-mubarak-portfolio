      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"This analysis shows that high-value customers tend to be:"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.38",
          marginTop: "12pt",
          textIndent: "-34.67px",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Satisfied with service"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.38",
          textIndent: "-34.67px",
          paddingLeft: "48px",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Located in San Francisco"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          marginTop: "15pt",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
