      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"CR and CTR per Device"}</span></p></div><img key={1} src={img_1} alt="Google Shape;72;p5" style={{
        position: "absolute",
        left: "47.51px",
        top: "111.25px",
        width: "462px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"CTR is around 3%"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          paddingLeft: "48px",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"CR is around 4-5%"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          paddingLeft: "48px",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Mobile is the highest CR and CTR device "}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          paddingLeft: "48px",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Ad quality and landing page performance are consistent and well-optimized across all devices."}</span></p></div></div></div>;
};
