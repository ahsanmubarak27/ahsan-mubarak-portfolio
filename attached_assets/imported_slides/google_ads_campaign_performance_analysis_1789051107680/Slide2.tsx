      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{" The aim of this analysis is to evaluate the performance of Google Ads campaigns based on CTR, CR, ROI, and funnel stages. By doing this, we can identify which part of the funnel has the biggest drop, and how to improve efficiency. "}</span></p></div></div></div>;
};
