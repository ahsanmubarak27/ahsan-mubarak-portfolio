      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"Fulfillment Rate Analysis for Supply Chain Optimization"}</span></p></div><div key={1} style={{
        position: "absolute",
        left: "48px",
        top: "366.14px",
        width: "722.77px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"Identifying potential drivers behind low fulfillment performance"}</span></p></div><div key={2} style={{
        position: "absolute",
        left: "48px",
        top: "462.42px",
        width: "253.48px",
