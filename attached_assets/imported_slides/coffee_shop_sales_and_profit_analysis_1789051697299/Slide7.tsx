      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#000000"
          }}>{"Sales by Market Size"}</span></p></div><img key={1} src={img_1} alt="Google Shape;86;p7" style={{
        position: "absolute",
        left: "47.51px",
        top: "113.31px",
        width: "482.7px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Major Market: $425,1k"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          paddingLeft: "48px",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Small Market: $394,7k"}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          paddingLeft: "48px",
          fontSize: "calc(16pt * var(--pptx-font-scale, 1))",
          ...
          marginBottom: "0"
            ...
            fontWeight: "500",
            color: "#000000"
          }}>{"Major Market leads by a significant margin, showing that larger markets are more lucrative. This should be a focal point for expanding campaigns."}</span></p><p style={{
          textAlign: "left",
          lineHeight: "1.2",
          marginTop: "12pt",
          paddingLeft: "48px",
